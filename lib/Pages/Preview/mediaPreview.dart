...
class MediaPreview extends StatefulWidget {
  ...
  MediaPreview({@required this.filepath,@required this.isFile,@required this.file});
  @override
                ...
                PageView.builder(
                    ...
                    onPageChanged: (val)async{
                      ...
                      if(widget.filepath[val].isVideo){
                        ...
                        _videoPlayerController?.dispose();
                        _videoPlayerController =   VideoPlayerController.network(widget.filepath[val].contentUrl);
                        _initializeVideoPlayerFuture =  _videoPlayerController.initialize();
                        //  _videoPlayerController.setLooping(true);
                          ...
                          Expanded(
                            child:widget.filepath[postindex].isVideo? GestureDetector(
                                ...
                                child: Stack(
                                  children: [
                                    Center(
                                      child: isVideoLoading ?loadingWidget: AspectRatio(
